...
- The SQL editor enforces tier permissions and tenant isolation in `backend/controllers/sqlEditor.js`.
- `POST /api/v1/exportData` expects `responseData` (from `/api/v1/query`) and `exportType` of `PDF` or `EXCEL`.
